    ...
    return (
            <div className="display__wrapper">
                <div className="display__inner-wrapper">
                        <span className="display__result" style={width <= 420 && value.length <= 14 ? {fontSize: 21} : width<= 420 && value.length > 14 ? {fontSize: 19} : width > 420 && value.length < 14 ? {fontSize: 24} : {fontSize: 19}}>
                        {value}
                    </span>
                </div>
            </div>
